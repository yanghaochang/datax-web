...
public abstract class BaseQueryTool implements QueryToolInterface {
    ...
    private void getDataSource(JobDatasource jobDatasource) throws SQLException {
        ...
        hikariConfig.setPassword(AESUtil.decrypt(jobDatasource.getJdbcPassword()));
        hikariConfig.setJdbcUrl(jobDatasource.getJdbcUrl());
        hikariConfig.setDriverClassName(jobDatasource.getJdbcDriverClass());
